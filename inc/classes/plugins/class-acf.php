					...
					array(
						...
						'fields'                => array(
							...
							array(
								...
								'label'             => 'Urls Android',
								'name'              => 'rgbc_menu_open_urls_android',
								'type'              => 'repeater',
								'instructions'      => '',
								'required'          => 0,
								'conditional_logic' => 0,
							...
							array(
								'key'               => 'field_62bd41e52f6c3',
								'label'             => 'Urls Mac',
								'name'              => 'rgbc_menu_open_urls_mac',
								'type'              => 'repeater',
								'instructions'      => '',
								'required'          => 0,
								'conditional_logic' => 0,
							...
							array(
								'key'               => 'field_62bd42042f6c6',
								'label'             => 'Urls Win',
								'name'              => 'rgbc_menu_open_urls_win',
								'type'              => 'repeater',
								'instructions'      => '',
								'required'          => 0,
								'conditional_logic' => 0,
