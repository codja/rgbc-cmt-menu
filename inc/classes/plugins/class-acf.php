		...
		if( function_exists('acf_add_local_field_group') ):
			...
			acf_add_local_field_group(array(
				...
				'fields' => array(
					...
					array(
						'key' => 'field_62b4740289c48',
						'label' => 'Urls desktop',
						'name' => 'rgbc_menu_open_urls_desktop',
						'type' => 'repeater',
						'instructions' => '',
						'required' => 0,
						'conditional_logic' => 0,
					...
					array(
						'key' => 'field_62b474b789c4d',
						'label' => 'Urls mobile',
						'name' => 'rgbc_menu_open_urls_mobile',
						'type' => 'repeater',
						'instructions' => '',
						'required' => 0,
						'conditional_logic' => 0,
