		...
		if( function_exists('acf_add_local_field_group') ):
			...
			acf_add_local_field_group(array(
				...
				'fields' => array(
					...
					array(
						'key' => 'field_62b16c03e7fd7',
						'label' => 'Bottom content',
						'name' => 'rgbc_menu_bottom_content',
						'type' => 'checkbox',
						'instructions' => '',
						'required' => 0,
						'conditional_logic' => 0,
					...
					array(
						'key' => 'field_62b17093e7fd8',
						'label' => 'Bottom content settings',
						'name' => 'rgbc_menu_bottom_content_settings',
						'type' => 'group',
						'instructions' => '',
						'required' => 0,
						'conditional_logic' => array(
						...
						'sub_fields' => array(
							...
							array(
								'key' => 'field_62b1862580013',
								'label' => 'Classes',
								'name' => 'classes',
								'type' => 'textarea',
								'instructions' => 'classname1,classname2,classname3',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
